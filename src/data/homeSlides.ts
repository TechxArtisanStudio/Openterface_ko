...
export const homeSlides: HomeSlide[] = [
  {
    ...
    secondaryCta: { label: '제품 보기', href: '/keymod/' },
  ...
  },
  {
    ...
    secondaryCta: { label: '제품 보기', href: '/kvmgo/' },
  ...
  },
  {
    ...
    secondaryCta: { label: '제품 보기', href: '/minikvm/' },
  ...
  },
  {
    ...
    secondaryCta: { label: '액세서리 보기', href: '/accessories/' },
